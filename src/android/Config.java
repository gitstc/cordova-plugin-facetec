...
import com.example.facetectest.R;
...
public class Config {
    ...
    public static String DeviceKeyIdentifier = "dg1g2T6RFJtsHayJr5Wa0H1Uaq1K0Rns";
    ...
    public static FaceTecCustomization retrieveConfigurationWizardCustomization() {
        ...
        int borderColor = Color.parseColor("#23096c");
        int ovalColor = Color.parseColor("#23096c");
        int dualSpinnerColor = Color.parseColor("#23096c");
        int textColor = Color.parseColor("#23096c");
        int buttonAndFeedbackBarColor =  Color.parseColor("#83bb02");
        int buttonAndFeedbackBarTextColor = Color.parseColor("#ffffff");
        int buttonColorHighlight = Color.parseColor("#23096c");
        int buttonColorDisabled = Color.parseColor("#d3cde5");
